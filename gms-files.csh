...
setenv  QMWAVE $USERSCR/$JOB.qmw
setenv   MDDIP $USERSCR/$JOB.dip
setenv OPTHES1 $USERSCR/$JOB.hs1
setenv OPTHES2 $USERSCR/$JOB.hs2
setenv     XYZ $SCR/$JOB.xyz
...
setenv  UNV    $SCR/$JOB.F45
setenv  UNPV   $SCR/$JOB.F46
...
setenv  DEN2P1 $SCR/$JOB.F70
setenv  DEN2P2 $SCR/$JOB.F71
setenv  DEN2P3 $SCR/$JOB.F72
setenv  DEN2P4 $SCR/$JOB.F73
#    Next files are for spatial no-migration 2nd order density
setenv  DEN2NM $SCR/$JOB.F74
setenv DEN2OPT $SCR/$JOB.F75
